  ...
  return (
    <footer className="footer p-10 bg-base-200 text-base-content">
      ...
      <nav>
        ...
        <a className="link link-hover">Bijoy Shorony</a>
        <a className="link link-hover">Rampura</a>
        <a className="link link-hover">Dhaka-1000</a>
        <a className="link link-hover">Bangladesh</a>
        <p className="mt-12 ml-12">
          Copyright © 2023 - All right reserved by Fresh Food Ltd
        </p>
      </nav>
      <nav>
        <header className="footer-title">Contact Information</header>
        <a className="link link-hover">Support: fresh@food.com</a>
        <a className="link link-hover">Helpline: 123456</a>
